  ...
  return (
    <section className="rivotFaqs" id="rivot-faqs" aria-labelledby="rivot-faqs-title">
      ...
      <style>{`
        ...
        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqs {
          background:
            radial-gradient(circle at 82% 12%, rgba(239, 116, 48, .08), transparent 30%),
            #080909 !important;
          color: #f5f5f2;
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqsShell {
          background: transparent !important;
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqsHeader h2,
        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem summary,
        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem summary span {
          color: #f5f5f2;
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem {
          background: #151717 !important;
          border: 1px solid rgba(255, 255, 255, .1);
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem p {
          color: #aeb4b4 !important;
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem summary i::before,
        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqItem summary i::after {
          background: #f5f5f2;
        }

        html:is([data-theme="dark"], [data-rivot-theme="dark"]) .rivotFaqTabs button:not(.active) {
